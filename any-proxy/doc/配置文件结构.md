...
测试源站配置文件：
any-proxys/any-proxy/examples/anyproxy/examples/conf/anyproxy_origin.conf
测试中转节点配置文件：
any-proxys/any-proxy/examples/anyproxy/examples/conf/anyproxy_proxy_to_origin.conf
测试边缘节点配置文件：
any-proxys/any-proxy/examples/anyproxy/examples/conf/anyproxy_edge_to_proxy.conf
各种配置文件例子：
any-proxys/any-proxy/examples/anyproxy/examples/conf/more_conf/
```
