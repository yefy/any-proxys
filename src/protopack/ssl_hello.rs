...
pub async fn read_domain(buf_reader: &mut BufReader<&StreamFlow>) -> Result<Option<String>> {
    buf_reader.start();
...
async fn read_do_domain(buf_reader: &mut BufReader<&StreamFlow>) -> Result<String> {
