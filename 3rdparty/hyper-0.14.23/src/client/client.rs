    ...
    B::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// # fn main() {}
    /// ```
    pub fn request(&self, mut req: Request<B>, arg: Option<ReqArg>) -> ResponseFuture {
        ...
        ResponseFuture::new(self.clone().retryably_send_request(req, pool_key, arg))
    }
    ...
    async fn retryably_send_request(
        ...
        loop {
            req = match self.send_request(req, pool_key.clone(), arg.clone()).await {
    ...
    async fn send_request(
        ...
        let mut pooled = match self.connection_for(pool_key, arg).await {
            Ok(pooled) => pooled,
    ...
    async fn connection_for(
        ...
        let connect = self.connect_to(pool_key, arg);
    ...
    fn connect_to(
        ...
        hyper_lazy(move || {
            ...
            Either::Left(
                connector
                    .connect(connect::sealed::Internal, dst, arg)
